...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, search, delete, usage, anime, count, config, updates, mediainfo
...
'''
    ...
    buttons.buildbutton("Leech 2.0", "https://t.me/joinchat/lVQ2fnj4AAE5ZmJl")
    buttons.buildbutton("Leech", "https://t.me/AnimeRepublicMLR")
...
<code>/tshelp</code>: Get help for Torrent search module.
'''
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        bot.edit_message_text("📶 BOT NOW UP", chat_id, msg_id)
    ...
    sendMessage(f"Bot Started!", context.bot)
