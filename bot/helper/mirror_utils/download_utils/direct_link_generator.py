...
def direct_link_generator(link: str):
    ...
    if not link:
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No links found!`")
    elif 'youtube.com' in link or 'youtu.be' in link:
        raise DirectDownloadLinkException(f"▶️ Youtube Link use /{BotCommands.WatchCommand} or /{BotCommands.TarWatchCommand}")
        ...
        raise DirectDownloadLinkException(f'🤷🏻‍♂️ No Direct link function found for {link}')
...
def cm_ru(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No cloud.mail.ru links found`\n")
...
def uptobox(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No Uptobox links found`\n")
...
def mediafire(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No MediaFire links found`\n")
...
def osdn(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No OSDN links found`\n")
    page = BeautifulSoup(
...
def github(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No GitHub Releases links found`\n")
...
def hxfile(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No Hxfile links found`\n")
...
def anon(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No Anonfiles links found`\n")
    bypasser = lk21.Bypass()
    dl_url=bypasser.bypass_url(link)
    return dl_url
...
def letsupload(url: str) -> str:
    ...
    try:
        ...
        raise DirectDownloadLinkException("`🤷🏻‍♂️ No Letsupload links found`\n")
    bypasser = lk21.Bypass()
    dl_url=bypasser.bypass_url(link)
    return dl_url
